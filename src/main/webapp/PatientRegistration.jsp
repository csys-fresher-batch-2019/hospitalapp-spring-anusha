...
button {
	background-color: pink;
		...
		<h3 align="center">
			<font color=blue>Fill the details for registration</font>
		</h3>
		<br />
		<center>
			<font color=blue>Enter Name : </font><input type="name" name="name"
				placeholder="Enter Name" required autofocus />
		</center>
		<br />
		<center>
			<font color=blue>Enter Age : </font><input type="number" name="age"
				placeholder="Enter Age" required />
		</center>
		<br />
		<center>
			<font color=blue>Gender: </font><input type="radio" name="gender"
				required value="M"> <font color=blue>Male</font> <input
				type="radio" name="gender" required value="F"> <font
				color=blue>Female</font>
		</center>
		<br />
		<center>
			<font color=blue>Enter Address : </font><input type="text"
				name="address" placeholder="Enter Address" required />
		</center>
		<br />
		<center>
			<font color=blue>Enter PhoneNumber : </font><input type="text"
				name="phNo" placeholder="Enter PhoneNumber" required maxlength="10"
