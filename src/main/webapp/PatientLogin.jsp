...
<body>
	...
	<form action="ServletPatientLogin">
		<h1>
			<center>
				<font color="blue">Patient Login </font>
			</center>
		</h1>
		<center>
			<font color="blue">Enter PhoneNumber : </font><input type="text"
				name="pPhoneNumber" placeholder="Enter PhoneNumber" required
				maxlength="10" pattern="\d{10}" title="Enter 10 digits" />
		</center>
		<br /> <br />
		<center>
			<font color="blue">Enter Password: </font><input type="password"
				name="patientPassword" required />
		</center>
		<ul>
			<center>
				<a href="ForgotPassword.jsp"><font color="blue">ForgotPassword?</font></a>
			</center>
		</ul>
		<center>
			<c:if test="${not empty errorMessage3}">
				<font color="red" style="font-style: normal" " class="a">${errorMessage3}
				</font>
			</c:if>
		</center>
		<center>
